...
//     return async function(dispatch) {
//         try {
//             const json = await axios.get(`http://localhost:3001/api/product/${id}`);
//             console.log("mi producto", json);
//             return dispatch({
//                 type: 'GET_DETAIL',
//                 payload: json.data
//             });
...
//     return async function (dispatch) {
//         try {
//             const response = await axios.get(`http://localhost:3001/api/user/categori/${categoriaId}`);
//             console.log("Productos por categoría:", response.data);
//             return dispatch({
//                 type: 'PRODUCTOS_POR_CATEGORIA',
//                 payload: response.data,
//             });
//         } catch (error) {
//             console.log(error);
...
export function updateCategori(id,newData){
    console.log(id)
    return async function(dispatch){
        try {
            const token = getAuthToken();
            ...
            const categoriUpdate = await axios.put(`http://localhost:3001/api/update/tipe/${id}`,newData,config)
